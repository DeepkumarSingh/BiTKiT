        ...
        <div className="flex flex-col w-full p-2 max-[768px]:flex-row max-[768px]:p-0 max-[768px]:gap-2">
          <div className="flex flex-col mb-1 max-[768px]:mb-0 max-[768px]:flex-grow">
            ...
            <NavLink
              to="/disc_forum_homepage"
              className={({ isActive }) =>
                `flex items-center gap-2 px-5 py-2 w-full transition-all no-underline hover:border-r-4 hover:border-blue-600 hover:bg-blue-50 hover:text-gray-900 dark:hover:text-white dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300
                ${isActive ? 'font-semibold text-[#0a4a89] dark:text-blue-400' : 'text-inherit'}
                max-[768px]:justify-center max-[768px]:px-3 max-[768px]:hover:border-r-0 max-[768px]:hover:border-b-2 max-[992px]:text-sm max-[480px]:text-xs`
              }
            >
              <QuestionAnswerIcon fontSize="small" />
              Questions

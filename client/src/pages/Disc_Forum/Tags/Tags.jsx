...
//     const filtered = tags.filter((tag) => tag.toLowerCase().includes(lowerSearch));
//     setFilteredTags(filtered);
//   }, [searchTerm, tags]);

//   if (loading) return <div className="px-5 py-10 max-w-6xl mx-auto dark:bg-gray-900 dark:text-gray-200">Loading tags...</div>;
//   if (error) return <div className="px-5 py-10 max-w-6xl mx-auto text-red-500 dark:text-red-400 dark:bg-gray-900">{error}</div>;
...
//         <h2 className="text-3xl font-semibold text-[#19376d] dark:text-gray-200 text-center">Explore Tags</h2>
//         <input
//           type="text"
...
//                 index % 8 === 5 || index % 8 === 6 || index % 8 === 7 ? 'min-w-[120px]' : 'min-w-fit'
//               }`}
//               key={`${tag}-${index}`}
...
//           ))
//         ) : (
//           <div className="text-lg text-gray-500 dark:text-gray-400 text-center py-5 w-full">No matches found for "{searchTerm}"</div>
//         )}
//       </div>
//     </div>
//   );
